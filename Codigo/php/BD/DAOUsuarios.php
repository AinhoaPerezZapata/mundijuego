<?php 
        ...
        function mostrarPerfil($conexion, $idUsuario)
	{
        ...
        function modificarPerfil($conexion, $usuario, $password, $nombre, $Apellido1, $Apellido2, $Telefono, $email, $CP, $Provincia, $ComunidadAutonoma, $FechaNacimiento, $Direccion, $idUsuario){
